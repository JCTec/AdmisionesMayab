                    ...
                    <div class="card">
                        ...
                        <script>
                            ...
                            $(document).ready(function () {
                                ...
                                var conQuienVives = parseInt("<?php echo e($ov->conQuienVives); ?>");
                                var quienPagaTusEstudios = parseInt("<?php echo e($ov->quienPagaTusEstudios); ?>");
                                var situacionPadres = "<?php echo e($ov->situacionPadres); ?>";
                                ...
                                var estudioEnExtranjero = parseInt("<?php echo e($ov->estudioEnExtranjero); ?>");
                                var examenesExtraordinarios = parseInt("<?php echo e($ov->examenesExtraordinarios); ?>");
                                var reprobarSemestre = parseInt("<?php echo e($ov->reprobarSemestre); ?>");
                                var universidadPrevia = parseInt("<?php echo e($ov->universidadPrevia); ?>");
                                ...
                                <?php if(isset($HA) && count($HA) != 0): ?>
                                    ...
                                    <?php $__currentLoopData = $HA; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($item->grado == 1): ?>
                                            primariaCount += 1;

                                            var section = primaria.clone();

                                            section.find('#primaria-nombre').attr('id', 'Primaria-' + primariaCount + '[nombre]').attr('name', 'Primaria-' + primariaCount + '[nombre]').val("<?php echo e($item->nombre); ?>");
                                            section.find('#primaria-ciudad').attr('id', 'Primaria-' + primariaCount + '[ciudad]').attr('name', 'Primaria-' + primariaCount + '[ciudad]').val("<?php echo e($item->ciudad); ?>");
                                            section.find('#primaria-promedio').attr('id', 'Primaria-' + primariaCount + '[promedio]').attr('name', 'Primaria-' + primariaCount + '[promedio]').val("<?php echo e($item->promedio); ?>");

                                            section.appendTo('#primariaSecction');

                                        <?php elseif($item->grado == 2): ?>
                                            primariaCount += 1;

                                            var section = secundaria.clone();

                                            section.find('#secundaria-nombre').attr('id', 'Secundaria-' + secundariaCount + '[nombre]').attr('name', 'Secundaria-' + secundariaCount + '[nombre]').val("<?php echo e($item->nombre); ?>");
                                            section.find('#secundaria-ciudad').attr('id', 'Secundaria-' + secundariaCount + '[ciudad]').attr('name', 'Secundaria-' + secundariaCount + '[ciudad]').val("<?php echo e($item->ciudad); ?>");
                                            section.find('#secundaria-promedio').attr('id', 'Secundaria-' + secundariaCount + '[promedio]').attr('name', 'Secundaria-' + secundariaCount + '[promedio]').val("<?php echo e($item->promedio); ?>");

                                            section.appendTo('#secundariaSecction');

                                        <?php elseif($item->grado == 3): ?>
                                            var section = prepa.clone();

                                            section.find('#prepa-nombre').attr('id', 'Preparatoria-' + prepaCount + '[nombre]').attr('name', 'Preparatoria-' + prepaCount + '[nombre]').val("<?php echo e($item->nombre); ?>");
                                            section.find('#prepa-ciudad').attr('id', 'Preparatoria-' + prepaCount + '[ciudad]').attr('name', 'Preparatoria-' + prepaCount + '[ciudad]').val("<?php echo e($item->ciudad); ?>");
                                            section.find('#prepa-promedio').attr('id', 'Preparatoria-' + prepaCount + '[promedio]').attr('name', 'Preparatoria-' + prepaCount + '[promedio]').val("<?php echo e($item->promedio); ?>");
                                ...
                                <?php if(isset($brothers) && count($brothers) != 0): ?>
                                    ...
                                    <?php $__currentLoopData = $brothers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        var section = template.clone();

                                        section.find('#Brother-nombre').attr('id', 'Brother-' + sectionsCount + '[nombre]').attr('name', 'Brother-' + sectionsCount + '[nombre]').val("<?php echo e($item->nombre); ?>");
                                        section.find('#Brother-sex').attr('id', 'Brother-' + sectionsCount + '[sex]').attr('name', 'Brother-' + sectionsCount + '[sex]').val("<?php echo e($item->sex); ?>");
                                        section.find('#Brother-edad').attr('id', 'Brother-' + sectionsCount + '[edad]').attr('name', 'Brother-' + sectionsCount + '[edad]').val("<?php echo e($item->edad); ?>");
                                        section.find('#Brother-trabajoEstudio').attr('id', 'Brother-' + sectionsCount + '[trabajoEstudio]').attr('name', 'Brother-' + sectionsCount + '[trabajoEstudio]').val("<?php echo e($item->trabajoEstudio); ?>");
