                            ...
                            <form role="form" method="POST" action="<?php echo e(route('user.createOV')); ?>" accept-charset="UTF-8" id="login-nav">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7 form-group">
                                        ...
                                        <input type="text" id="puestoTrabajoPrevio" name="puestoTrabajoPrevio" placeholder="Descripción del puesto que desempeñastes" class="form-control"  value="<?php echo e($ov->puestoTrabajoPrevio); ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 form-group">
                                        ...
                                        <input type="text" id="razonExperienciaLaboralElegirCarrera" name="razonExperienciaLaboralElegirCarrera" placeholder="Explica porque sientes que tu experiencia laboral te ha resultado útil" value="<?php echo e($ov->razonExperienciaLaboralElegirCarrera); ?>"  class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7 form-group">
                                        ...
                                        <input type="text" id="razonTrabajoActual" name="razonTrabajoActual" placeholder="Explica porque trabajas actualmente" class="form-control"  value="<?php echo e($ov->razonTrabajoActual); ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 form-group">
                                        ...
                                        <input type="text" id="empresaTrabajoActual" name="empresaTrabajoActual" placeholder="Nombre de la organización o empresa en la que trabajas" class="form-control" value="<?php echo e($ov->empresaTrabajoActual); ?>"  required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 form-group">
                                        ...
                                        <input type="text" id="tipoAsistenciaNecesitada" name="tipoAsistenciaNecesitada" placeholder="Explica que tipo de asistencia requieres" class="form-control" value="<?php echo e($ov->tipoAsistenciaNecesitada); ?>"  required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 form-group">
                                        ...
                                        <input type="text" id="tipoDeExamenNecesitado" name="tipoDeExamenNecesitado" placeholder="Explica que tipo de modalidad de examenes requieres" class="form-control" value="<?php echo e($ov->tipoDeExamenNecesitado); ?>"  required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 form-group">
                                        ...
                                        <input type="text" id="tipoProblemaContinuoSalud" name="tipoProblemaContinuoSalud" placeholder="Explica que problema de salud tienes" class="form-control" value="<?php echo e($ov->tipoProblemaContinuoSalud); ?>"  required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 form-group">
                                        ...
                                        <input type="text" id="tipoDeTerapiaRecibida" name="tipoDeTerapiaRecibida" placeholder="Explica que tipo de terapia has recibido" class="form-control" value="<?php echo e($ov->tipoDeTerapiaRecibida); ?>"  required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 form-group">
                                        ...
                                        <input type="text" id="razonDeTerapiaRecibida" name="razonDeTerapiaRecibida" class="form-control" placeholder="Explica el porqué recibistes terapia" value="<?php echo e($ov->razonDeTerapiaRecibida); ?>"  required>
                                    </div>
                                </div>
