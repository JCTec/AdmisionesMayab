...
<div class="container justify-content-start py-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center"><?php echo e(__('Iniciar sesión')); ?></div>
                    ...
                    <form method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="remember" <?php echo e(old('remember') ? 'checked' : ''); ?>> <?php echo e(__('Mantener sesión abierta')); ?>
