...
<div class="container py-5">
    <div class="row justify-content-center">
        ...
        <div id="home">
            ...
            <div id="menuJC">
                <ul>
                    <li><a id="basico" href="<?php echo e(route('cuestionario')); ?>">Basico</a>
                    </li>
                    <li><a id="pago" href="<?php echo e(route('payment')); ?>">Pago</a>
                    </li>
                    <li><a id="subirArchivos" href="<?php echo e(route('uploadFiles')); ?>">Archivos</a>
                    </li>
                    <li><a id="familia" href="<?php echo e(route('familiar')); ?>">Familia</a>
                    </li>
                    <li><a id="ov" href="<?php echo e(route('orientacionVocacional')); ?>">OV</a>
                    </li>
                </ul>
            </div>
        </div>
